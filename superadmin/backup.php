...
if (isset($_GET['scarica'])) {
    ...
    echo "-- ============================================================\n";
    echo "-- Backup del database " . DB_NAME . " (tutte le aziende)\n";
    echo "-- Generato il " . date('Y-m-d H:i:s') . " da MRP Elettronica (superadmin/backup.php)\n";
    echo "-- ============================================================\n\n";
...
<p class="text-muted">Esporta una copia completa del database — <strong>di tutte le aziende insieme</strong> — in un file <code>.sql</code> standard, importabile con phpMyAdmin o dal client <code>mysql</code>. Riservato al Super Admin perché tocca dati di tutti i tenant.</p>
...
<div class="alert alert-warning">
  <i class="bi bi-exclamation-triangle"></i> Il file generato contiene <strong>i dati di tutte le aziende</strong>, incluse le chiavi API dei distributori configurate nei rispettivi Fornitori. Conservalo in un posto sicuro e non condividerlo né caricarlo su repository pubblici.
</div>
...
<a href="index.php" class="btn btn-outline-secondary mt-2">Torna alla dashboard Super Admin</a>
